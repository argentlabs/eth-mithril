...
public:
    ...
    merkle_path_authenticator(
        ...
        const VariableArrayT in_path,
        const std::string &in_annotation_prefix) : markle_path_compute<HashT>::markle_path_compute(in_pb, in_depth, in_address_bits, in_IVs, in_leaf, in_path, in_annotation_prefix),
