...
class LongsightL12p5_gadget : public LongsightL_gadget
{
  public:
    LongsightL12p5_gadget(
        ...
        const VariableT &in_x,
        const VariableT &in_k,
        const std::string &in_annotation_prefix = "") : LongsightL_gadget(in_pb, LongsightL12p5_constants_assign(), in_x, in_k, in_annotation_prefix)
    {
    }
};
...
class LongsightL12p5_MP_gadget : public MiyaguchiPreneel_OWF<LongsightL12p5_gadget>
{
  public:
    LongsightL12p5_MP_gadget(
        ...
        const std::string &in_annotation_prefix = "") : MiyaguchiPreneel_OWF(in_pb, in_IV, in_messages, FMT(in_annotation_prefix, ".MP_OWF"))
    {
    }
};
